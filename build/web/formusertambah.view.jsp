...
<body>
    <div class="form-container">
        <div class="main-container">
            <div class="text-center mb-4">
                ...
                <p class="page-subtitle">Lengkapi data pengguna di bawah ini</p>
            </div>
            ...
            <div class="card-footer">
                <a href="userlist.jsp" class="btn-link">
    ...
    <script>
        document.querySelectorAll('.btn-primary, .btn-outline-secondary, .btn-link').forEach(button => {
